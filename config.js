...
//____________________________________________________________________________________________________________________________________________  
  SESSION_ID: process.env.SESSION_ID || 'Phoenix~CipherBeta',
  STICKER_DATA: process.env.STICKER_DATA || '𝛥𝐿𝛯𝛸_𝛲𝛪𝛫𝑈;𝛥𝐿𝛯𝛸_𝛲𝛪𝛫𝑈-𝛭𝐷',
  ALIVE_DATA: process.env.ALIVE_DATA || '👋 ʜᴇʏ &sender, ɪ ᴍ * 𝙰𝙻𝙴𝚇_𝙿𝙸𝙺𝚄-ᴍᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ* ᴀʟɪᴠᴇ ɴᴏᴡ!\n\n📌 ᴛʏᴘᴇ *menu* ᴛᴏ ɢᴇᴛ ᴍʏ ᴄᴏᴍᴍᴀɴᴅ ʟɪꜱᴛ.\n\n*ᴘʟᴀᴛꜰᴏʀᴍ:* &platform\n*ʀᴜɴᴛɪᴍᴇ:* &runtime;https://qu.ax/ZfXCR.jpg',
  AUDIO_DATA: process.env.AUDIO_DATA || ' 𝙰𝙻𝙴𝚇_𝙿𝙸𝙺𝚄; 𝙰𝙻𝙴𝚇_𝙿𝙸𝙺𝚄-𝙼𝙳 Suresh;https://qu.ax/ZfXCR.jpg',
  BOT_INFO: process.env.BOT_INFO || ' 𝙰𝙻𝙴𝚇_𝙿𝙸𝙺𝚄; 𝙰𝙻𝙴𝚇_𝙿𝙸𝙺𝚄-𝙼𝙳 ꜱᴜʀᴇꜱʜ;918536881026;https://qu.ax/ZfXCR.jpg', 
